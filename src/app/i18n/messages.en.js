...
const Messages =
{
    ...
    ROUSER_WELCOME_3: 'When you’re ready, you’ll receive a phone call to record your message. You can listen and rerecord as many times as you wish. Stir will then deliver the message to your Sleeper.',
    ...
    SLEEPER_SUMMARY_FAILED: 'Hi {name}, sorry we weren\'t able to deliver your wakeup message.',
    ...
    FAIL_NOTIFY: 'This is a message from STIR. We\'re sorry {name}, but due to an analysis failture we are unable to deliver your wakeup message at {time, time, short}.',
